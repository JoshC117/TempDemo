...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture,overlay,anchor = north]
        % Project Overview
        \node[table_number] at (3,-3) {1};
        \node[table_heading] at (12,-3.5) {Project Overview};
        % Methodologies
        \node[table_number] at (3,-6) {3};
        \node[table_heading] at (12,-6.5) {Proposed Methogology};
        % The Team
        \node[table_number] at (3,-9) {4};
        \node[table_heading] at (12,-9.5) {The Team}; 
        % Why Us?
        \node[table_number] at (3,-12) {9};
        \node[table_heading] at (12,-12.5) {Why Us?}; 
    \end{tikzpicture}
	...
	\begin{figure}[htb]
	\framebox[\textwidth][l]{\includegraphics[width=0.95\textwidth]{deployment.png}}
